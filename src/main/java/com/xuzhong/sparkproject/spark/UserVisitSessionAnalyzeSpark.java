...
import com.xuzhong.sparkproject.dao.DAOFactory;
...
import com.xuzhong.sparkproject.util.ValidUtils;
...
public class UserVisitSessionAnalyzeSpark {
	...
	private static TaskMapper taskMapper4static;

	@PostConstruct
	public void init(){
		this.taskMapper4static = taskMapper;
		System.err.println(taskMapper.selectByPrimaryKey(1).getTaskName());
		System.err.println(this.taskMapper4static.selectByPrimaryKey(1).getTaskName());
	}
	...
	public static void main(String[] args) {
		...
		System.err.println(sessionid2AggrInfoRDD.count());
