package com.xuzhong.sparkproject.spark.page;
...
public class PageOneStepConvertRateSpark {
	...
	private static void persistConvertRate(long taskid,
		...
		PageSplitConvertRateMapper pageSplitConvertRateMapper = ApplicationContextUtils.getBean(PageSplitConvertRateMapper.class);
		pageSplitConvertRateMapper.insert(pageSplitConvertRate); 
	}
}
