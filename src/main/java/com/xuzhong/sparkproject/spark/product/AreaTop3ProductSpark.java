package com.xuzhong.sparkproject.spark.product;
...
import com.xuzhong.sparkproject.dao.AreaTop3ProductMapper;
...
public class AreaTop3ProductSpark {
	...
	public static void run(Task task) {
		System.out.println("=============AreaTop3ProductSpark : run=============");
...
//				+ "JOIN tmp_product_info pi ON tapcc.product_id=pi.product_id ";
	...
	private static void persistAreaTop3Product(long taskid, List<Row> rows) {
		...
		AreaTop3ProductMapper top3ProductMapper = ApplicationContextUtils.getBean(AreaTop3ProductMapper.class);
		for(Row row : rows) {
			...
			top3ProductMapper.insert(areaTop3Product);
		}
